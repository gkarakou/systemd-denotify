...
class DbusNotify():
    ...
    def run(self):
        ...
        #print "typeof services: "+ isinstance(config_services, str)+ " services :"+ str(config_services)
        journal.send("systemd-notify: "+ "services is string? " + isinstance(config_services,str))
        lists = []
